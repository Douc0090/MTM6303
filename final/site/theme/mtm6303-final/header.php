<?php
/**
 * Header template for mtm6303 final
 *
...
<title><?php
	...
	if ( ( $paged >= 2 || $page >= 2 ) && ! is_404() )
		echo esc_html( ' | ' . sprintf( __( 'Page %s', 'mtm6303-final' ), max( $paged, $page ) ) );
...
?></li>
        ...
        ?>
            <li>
                <a href="<?php echo $menu_item["url"] ?>" title=""> <?php echo $menu_item["title"] ?></a>
        </li>
        <?php
           }
          ?> -->